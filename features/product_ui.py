...
def render_specialist_sidebar(active_page: str) -> None:
    with st.sidebar:
        ...
        st.page_link("pages/1_Match_Intelligence.py", label="Live Match", icon="🎯")
        st.page_link("pages/2_Qualification_Lab.py", label="Qualification", icon="🧭")
        st.page_link("pages/3_Live_Group_Centre.py", label="Groups", icon="📋")
        st.page_link("pages/7_Tournament_Path.py", label="Country Path", icon="🛣️")
