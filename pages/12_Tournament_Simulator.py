...
st.markdown(
    '''
    <div class="cm-hero">
        <div class="cm-eyebrow">CupMarket 2026 - Simulator</div>
        <h1>Test a result before it happens.</h1>
        <p>Build sandbox knockout scenarios, compare possible CM movement, and read live-from-here projections without changing the official market.</p>
    </div>
    ''',
